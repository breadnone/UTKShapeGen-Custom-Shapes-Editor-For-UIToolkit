...
namespace UTK
{
    ...
    public class UTKRoundSlimToggle : BindableElement, INotifyValueChanged<bool>
    {
        ...
        public UTKRoundSlimToggle()
        {
            ...
            containers.mainContainer.FlexRow().FlexGrow(1);
            ...
            var line = Resources.Load<Sprite>("ROUND-LINE-utk-512");
            var sprite = Resources.Load<Sprite>("circle-utk-512-full");
