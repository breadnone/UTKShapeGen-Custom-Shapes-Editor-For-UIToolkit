...
namespace UTK
{
    ...
    public class UTKToggleSquareBold : BindableElement, INotifyValueChanged<bool>
    {
        ...
        public UTKToggleSquareBold()
        {
            ...
            var line = new VisualElement().Size(100, 100, true, true).BcgColor("#744da9").AlignSelf(Align.Center).RoundCorner(Utk.ScreenRatio(5));
