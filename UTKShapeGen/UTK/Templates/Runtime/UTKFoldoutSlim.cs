...
namespace UTK
{
    public class UTKFoldoutSlim : VisualElement, INotifyValueChanged<bool>
    {
        public (UTKRoundToggle toggle, Label title) elements { get; set; }
        ...
        public UTKFoldoutSlim(string text = "", bool defaultIsFolded = true)
        {
            this.FlexColumn();
            ...
            elements = (new UTKRoundToggle(), new Label());
