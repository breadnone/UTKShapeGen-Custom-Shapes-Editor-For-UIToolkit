...
namespace UTK
{
    public class UTKMenuSideBorder : VisualElement, IUState<VisualElement>, INotifyValueChanged<string>
    {
        ...
        public UTKMenuSideBorder(string menuTitle, bool rightBorder = true, bool leftBorder = false)
        {
            ...
            containers.title.Text(menuTitle).BorderLeft(Utk.ScreenRatio(leftB), Utk.HexColor(Color.clear, "#0063b1")).BorderRight(Utk.ScreenRatio(rightB), Utk.HexColor(Color.clear, "#0063b1")).Size(100, 100, true, true).TextAlignment(TextAnchor.MiddleCenter).Name("mainTitle").PickingMode(PickingMode.Position);
        ...
        public UTKMenuSideBorder AddMenu(string menu, Action callback)
        {
        ...
        public UTKMenuSideBorder AddMenus(List<(string menu, Action callback)> menuList)
        {
        ...
        public UTKMenuSideBorder SetLeftBorderStyle(float value, Color color)
        {
            containers.title.BorderLeft(Utk.ScreenRatio(value), color);
            return this;
        }

        public UTKMenuSideBorder SetRightBorderStyle(float value, Color color)
        {
            containers.title.BorderRight(Utk.ScreenRatio(value), color);
            return this;
        }
    }
}