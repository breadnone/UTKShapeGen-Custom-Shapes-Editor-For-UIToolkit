...
namespace UTK
{
    ...
    public class UTKRadioButtonRound : BindableElement, INotifyValueChanged<bool>
    {
        ...
        public UTKRadioButtonRound(string text = "Radio Button")
        {
            focusable = true;
            ...
            containers.toggle.AddChild(containers.innerToggle).Padding(Utk.ScreenRatio(3), true).JustifyContent(Justify.Center).RoundCorner(Utk.ScreenRatio(20)).Border(Utk.ScreenRatio(5), Utk.HexColor(Color.clear, "#8e8cd8")).Size(Utk.ScreenRatio(35), Utk.ScreenRatio(35), false, false);
            containers.innerToggle.BcgColor("#b146c2").Size(100, 100, true, true).FlexGrow(1).JustifyContent(Justify.Center).RoundCorner(Utk.ScreenRatio(20));
