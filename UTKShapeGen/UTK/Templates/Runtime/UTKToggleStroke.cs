...
namespace UTK
{
    ...
    public class UTKToggleStroke : BindableElement, INotifyValueChanged<bool>
    {
        ...
        public UTKToggleStroke()
        {
            ...
            containers.leftLabel.Position(Position.Absolute).Left(0, true).RoundCorner(Utk.ScreenRatio(5)).Border(Utk.ScreenRatio(5), Utk.HexColor(Color.clear, "#8e8cd8"));
            containers.rightLabel.Position(Position.Absolute).Left(50, true).RoundCorner(Utk.ScreenRatio(5)).Border(Utk.ScreenRatio(5), Utk.HexColor(Color.clear, "#8e8cd8"));
